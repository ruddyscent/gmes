...
def _load_manifest(path):
    ...
    _validate_digest(reference.get("observer_commit"), "observer commit")
...
def _validate_cell(
    ...
    mode, threads, normalized_environment = _validate_environment(
        cell["environment"], reference["observer_commit"], expected_threads
    )
